...
// public $sortable =['id','name'];
    ...
    public function imagedata($filename, $Path, $width, $height,$type, $user_id = null){
        ...
        $imagecatedata = DB::table('image_categories')->insert([
            ['image_id' => $image_id, 'image_type' => '1', 'height' =>$height,'width' =>$width,'path' =>$Path,'path_type' =>$type]
        ]);
        return $image_id;

    }

    public function thumbnailrecord($filename,$Path,$width,$height,$type){
      $getimage_id =  DB::table('images')->where('name', $filename)->first();
      $image_id = $getimage_id->id;

      $imagecatedata = DB::table('image_categories')->insert([
        ['image_id' => $image_id, 'image_type' => '2', 'height' =>$height,'width' =>$width,'path' =>$Path,'path_type' =>$type]
      ]);
    }


    public function Mediumrecord($filename,$Path,$width,$height,$type){
        $getimage_id =  DB::table('images')->where('name', $filename)->first();
        $image_id = $getimage_id->id;
        $imagecatedata = DB::table('image_categories')->insert([
            ['image_id' => $image_id, 'image_type' => '4', 'height' =>$height,'width' =>$width,'path' =>$Path,'path_type' =>$type]
        ]);

    }

    public function Largerecord($filename,$Path,$width,$height,$type){
        ...
        $imagecatedata = DB::table('image_categories')->insert([
            ['image_id' => $image_id, 'image_type' => '3', 'height' =>$height,'width' =>$width,'path' =>$Path,'path_type' =>$type, 
